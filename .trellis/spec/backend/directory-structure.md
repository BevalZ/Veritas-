...
- `veritas/web_runner.py` owns local Web Runner helper functions that do not
  ...
  markup/script-wrapper/path-script/input-script/report-script/run-script/bootstrap-script/HTML rendering, Web Runner audit subprocess command preparation, and
