...
- `veritas/report_html_fragments.py` owns top-level HTML report fragments such
  ...
  banners, score breakdown text, document head/CSS shell including compact-skin
  overrides, body/header/stat/footer shell, and the namespace-aware render context used by that shell. It should stay
